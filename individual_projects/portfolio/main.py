...
def main():
    ...
    while True:
        button = graphics.Menu(["Fractal Pattern Generator","Slots","Personal library","Morse Code Translaotor"]).use()
        match button:
            case "Fractal Pattern Generator":
                ...
                fractal_pattern_generator.fractal_main()
            case "Slots":
            ...
            case "Personal library":
                ...
                updated_per_library.main_menu("individual_projects/portfolio/library.csv")
            ...
            case _:
                graphics.show("That is not an option please try again.")
main()